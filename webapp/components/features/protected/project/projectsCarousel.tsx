...
export const ProjectsCarousel = ({ projects, setProjects }: ProjectsCarouselProps) => {
              ...
              <div className="p-1">
                <Card className="min-h-55 bg-gray-100 p-4 rounded-lg shadow-lg hover:bg-gray-200">
                    ...
                    <div className="flex items-center w-full min-h-25 gap-x-4">
                      ...
                      <Button variant="ghost" className="opacity-0 group-hover:opacity-100 hover:bg-gray-300">
                        <ChevronRight />
                      </Button>
                    </div>
                    </CardContent>
